...
// ------------------------------------
// ------------------------------------
module.exports = async function setVersion(
  argProductName,
  argConfigDirectory,
  argSetupFileName,
  argSetupVersion
  ...
  var setupFileDataReplaced = setupFileData.replace(
    versionRegex,
    '$1' + argSetupVersion + '$3'
  )
  try {
    ...
    actionsCore.setFailed(
      'Unable to write setup file[' + setupFile + ']' + error
    )
    return
  }
